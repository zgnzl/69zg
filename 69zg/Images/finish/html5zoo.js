(function($) {
    $.fn.html5lightbox = function(k) {
        ...
        l.createMarkup = function() {
            ...
            l.$lightbox = jQuery("<div id='html5-lightbox' style='display:none;top:0px;left:0px;width:99%;height:99%;z-index:9999999;'><div id='html5-lightbox-overlay' style='display:block;position:absolute;top:0px;left:0px;width:99%;height:99%;background-color:" + l.options.overlaybgcolor + ";opacity:" + l.options.overlayopacity + ";filter:alpha(opacity=" + Math.round(l.options.overlayopacity * 100) + ");'></div><div id='html5-lightbox-box' style='display:block;position:relative;margin:0px auto;overflow:hidden;'><div id='html5-elem-box' style='display:block;position:relative;margin:0px auto;text-align:center;'><div id='html5-elem-wrap' style='display:block;position:relative;margin:0px auto;text-align:center;background-color:" + l.options.bgcolor + ";'><div id='html5-loading' style='display:none;position:absolute;top:0px;left:0px;text-align:center;width:99%;height:99%;background:url(\"" + l.options.skinfolder + l.options.loadingimage + "\") no-repeat center center;'></div><div id='html5-error' class='html5-error' style='display:none;position:absolute;padding:" + l.options.bordersize + "px;text-align:center;width:" + l.options.errorwidth + "px;height:" + l.options.errorheight + "px;'>The requested content cannot be loaded.<br />Please try again later.</div><div id='html5-image' style='display:none;position:absolute;top:0px;left:0px;padding:" + l.options.bordersize + "px;text-align:center;'></div></div><div id='html5-next' style='display:none;cursor:pointer;position:absolute;right:" + l.options.bordersize + "px;top:40%;'><img src='" + l.options.skinfolder + l.options.nextimage + "'></div><div id='html5-prev' style='display:none;cursor:pointer;position:absolute;left:" + l.options.bordersize + "px;top:40%;'><img src='" + l.options.skinfolder + l.options.previmage + "'></div></div><div id='html5-elem-data-box' style='display:none;position:relative;width:99%;margin:0px auto;height:" + l.options.barheight + "px;background-color:" + l.options.bgcolor + ";'><div id='html5-text' style='display:block;float:left;overflow:hidden;margin-left:" + l.options.bordersize + "px;'></div><div id='html5-close' style='display:block;cursor:pointer;float:right;margin-right:" + l.options.bordersize + "px;'><img src='" + l.options.skinfolder + l.options.closeimage + "'></div></div><div id='html5-watermark' style='display:none;position:absolute;left:" + String(l.options.bordersize + 2) + "px;top:" + String(l.options.bordersize + 2) + "px;'></div></div></div>");
            l.$lightbox.css({
...
//                a.createBackgroundImage();
            ...
            createStyle: function() {
                $(".html5zoo-space-" + this.id, this.container).html("<img style='width:99%;width:99%;' src='" + this.elemArray[0][ELEM_SRC] + "' />");
...
//                var a = ".html5zoo-wrapper-" + this.id + " {display:block;position:relative;width:99%;height:auto;}";
                var a = ".html5zoo-wrapper-" + this.id + " {display:block;position:relative;width:99%;height:"+this.options.height+"px;}";
                a += ".html5zoo-slider-" + this.id + " {display:block;position:relative;left:0px;top:0px;width:99%;height:auto;";
                ...
                a += "}";
                a += ".html5zoo-box-" + this.id + " {display:block;position:relative;left:0px;top:0px;width:99%;height:auto;}";
                a += ".html5zoo-swipe-box-" + this.id + " {display:block;position:relative;left:0px;top:0px;width:99%;height:auto;}";
                a += ".html5zoo-space-" + this.id + " {display:block;position:relative;left:0px;top:0px;width:99%;height:auto;visibility:hidden;line-height:0px;font-size:0px;}";
//                a += ".html5zoo-img-box-" + this.id + " {display:block;position:absolute;left:0px;top:0px;width:99%;height:99%;}";
                a += ".html5zoo-img-box-" + this.id + " {display:block;position:absolute;left:0px;top:0px;width:99%;height:"+this.options.height+"px;}";
                ...
                if (this.options.showribbon) {
                    ...
                    case 'bottomright':
                        ...
                        break;
                    case 'top':
                        a += "width:99%;height:auto;margin:0 auto;top:" + this.options.ribbonimagey + "px;";
                    case 'bottom':
                        a += "width:99%;height:auto;text-align:center;bottom:" + this.options.ribbonimagey + "px;"
                    }
                    a += "}"
                }
                a += ".html5zoo-video-wrapper-" + this.id + " video {width:99%;height:auto;}";
                a += ".html5zoo-video-wrapper-" + this.id + " iframe, .html5zoo-video-wrapper-" + this.id + " object, .html5zoo-video-wrapper-" + this.id + " embed {position:absolute;top:0;left:0;width:99%;height:99%;}";
            ...
            createBottomShadow: function() {
                ...
                a.html("<img src='" + this.options.skinsfolder + this.options.bottomshadowimage + "' style='display:block;position:relative;width:99%;height:auto;' />")
            },
            createBackgroundImage: function() {
                ...
                a.html("<img src='" + this.options.skinsfolder + this.options.backgroundimage + "' style='display:block;position:relative;width:99%;height:auto;' />")
            },
...
//                     k = k +100
                ...
                if (this.options.navstyle != 'none') {
                    ...
                    if (this.options.navshowpreview) {
                        ...
                        var z = $("<div class='html5zoo-nav-preview-images-" + this.id + "' style='display:block;position:relative;width:99%;height:99%;overflow:hidden;' />");
                        x.append(y);
                        x.append(z);
                        if (this.options.navshowplayvideo) {
                            var A = $("<div class='html5zoo-nav-preview-play-" + this.id + "' style='display:none;position:absolute;left:0;top:0;width:99%;height:99%;background:url(\"" + this.options.skinsfolder + this.options.navplayvideoimage + "\") no-repeat center center;' ></div>");
                            x.append(A)
                        }
            ...
            createNavBullet: function(r) {
                ...
                if (this.options.navstyle == 'bullets') {
                    ...
                    $(y).load(function() {
                        var a;
                        if (this.width / this.height <= s.options.navimagewidth / s.options.navimageheight) a = "width:none !important;width:99%;height:auto;margin-top:-" + Math.floor((this.height / this.width) * s.options.navimagewidth / 2 - s.options.navimageheight / 2) + "px";
                        else a = "width:none !important;width:auto;height:99%;margin-left:-" + Math.floor((this.width / this.height) * s.options.navimageheight / 2 - s.options.navimagewidth / 2) + "px";
            ...
            slideRun: function(a) {
                ...
                if (this.isAnimating) {
                  ...
                  //  $(".html5zoo-img-box-" + this.id, this.container).unbind('transitionFinished').html("<div class='html5zoo-img-" + this.id + " ' style='display:block;position:absolute;left:0px;top:0px;width:99%;height:auto;'><img style='position:absolute;width:99%;height:auto;left:0%;top:0%;' src='" + this.elemArray[savedCur][ELEM_SRC] + "' /></div>");
                    $(".html5zoo-img-box-" + this.id, this.container).unbind('transitionFinished').html("<div class='html5zoo-img-" + this.id + " ' style='display:block;position:absolute;left:0px;top:0px;width:99%;height:auto;'><img style='position:absolute;width:99%;height:"+this.options.height+"px;left:0%;top:0%;' src='" + this.elemArray[savedCur][ELEM_SRC] + "' /></div>");
            ...
            showImage: function(g) {
                ...
                $(i).load(function() {
                 ...
                 //去宽高   var e = $("<div class='html5zoo-img-" + h.id + " ' style='display:block;position:absolute;left:0px;top:0px;width:99%;height:auto;'><img style='position:absolute;" + (ASPlatforms.isIE678() ? "opacity:inherit;filter:inherit;": "") + "width:" + b + "%;height:auto;left:" + (100 - b) / 2 + "%;top:0%;' src='" + h.elemArray[h.curElem][ELEM_SRC] + "' /></div>");
        ...
        this.each(function() {
            ...
            var j = {
                ...
                textbgcss: 'display:block; position:absolute; top:0px; left:0px; width:99%; height:99%; background-color:#333333; opacity:0.6; filter:alpha(opacity=60);',
...
/*                    left: '99%'*/
    ...
    $.fn.sliceTransition = function(b, c, d, e, f, g) {
        ...
        for (i = 0; i < e.slicecount; i++) {
            var k = $("<div class='html5zoo-img-slice-" + b + " ' style='display:block;position:absolute;left:" + i * j + "px;top:0%;width:" + j + "px;height:99%;overflow:hidden;'></div>");
    ...
    $.fn.blindsTransition = function(c, d, e, f, g, h) {
        ...
        for (i = 0; i < f.slicecount; i++) {
            var l = $("<div class='html5zoo-img-slice-wrapper-" + c + " ' style='display:block;position:absolute;left:" + i * k + "px;top:0%;width:" + k + "px;height:99%;overflow:hidden;'></div>");
            var m = $("<div class='html5zoo-img-slice-" + c + " ' style='display:block;position:absolute;left:0%;top:0%;width:99%;height:99%;overflow:hidden;'></div>");
    ...
    $.fn.threedTransition = function(d, e, f, g, j, k) {
        ...
        var n = $("<div class='html5zoo-img-cube-wrapper-" + d + " ' style='display:block;position:absolute;left:0%;top:0%;width:99%;height:99%;'></div>");
        l.append(n);
        ...
        for (i = 0; i < g.slicecount; i++) {
            ...
            var p = $("<div class='html5zoo-img-slice-" + d + " ' style='display:block;position:absolute;left:0%;top:0%;width:99%;height:99%;overflow:hidden;outline:1px solid transparent;background-color:" + g.bgcolor + ";'></div>");
            p.append(o);
            ...
            var r = $("<div class='html5zoo-img-slice-" + d + " ' style='display:block;position:absolute;left:0%;top:0%;width:99%;height:99%;overflow:hidden;outline:1px solid transparent;background-color:" + g.bgcolor + ";'></div>");
            r.append(q);
            ...
            var u = $("<div class='html5zoo-img-cube-" + d + " ' style='display:block;position:absolute;left:" + i * m + "px;top:0%;width:" + m + "px;height:99%;'></div>");
            u.append(s);
            u.append(t);
            u.append(p);
            u.append(r);
    ...
    $.fn.threedHorizontalTransition = function(d, e, f, g, j, k) {
        ...
        for (i = 0; i < g.slicecount; i++) {
            ...
            var u = $("<div class='html5zoo-img-cube-" + d + " ' style='display:block;position:absolute;left:0%;top:" + i * m + "px;width:99%;height:" + m + "px;'></div>");
            u.append(s);
            u.append(t);
            u.append(p);
            u.append(r);
    ...
    $.fn.blocksTransition = function(c, d, e, f, g, k) {
        ...
        for (i = 0; i < f.rowcount; i++) {
            for (j = 0; j < f.columncount; j++) {
                ...
                var r = $("<div class='xunsliderimg html5zoo-img-block-" + c + " ' style='display:block;position:absolute;left:0%;top:0%;width:99%;height:99%;overflow:hidden;'></div>");
    ...
    $.fn.shuffleTransition = function(f, g, k, l, m, n) {
        ...
        for (i = 0; i < l.rowcount; i++) {
            for (j = 0; j < l.columncount; j++) {
                ...
                var s = $("<div class='html5zoo-img-block-next-" + f + " ' style='display:block;position:absolute;left:0%;top:0%;width:99%;height:99%;overflow:hidden;'></div>");
                ...
                var v = $("<div class='html5zoo-img-block-prev-" + f + " ' style='display:block;position:absolute;left:0%;top:0%;width:99%;height:99%;overflow:hidden;'></div>");
