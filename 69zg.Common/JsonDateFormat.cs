...
{
    public class JsonDateFormat : JsonResult
    {
        public JsonDateFormat() { }
        public JsonDateFormat(object data, JsonRequestBehavior behavior)
        {
            base.Data = data;
            base.JsonRequestBehavior = behavior;
            this.DateTimeFormat = "yyyy-MM-dd HH:mm:ss";
        }
        public JsonDateFormat(object data, String dateTimeFormat)
        {
            base.Data = data;
        ...
        public static string GetString(object models)
        {
